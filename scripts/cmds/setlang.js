...
module.exports = {
	...
	langs: {
		...
		fil: {
			...
			setLangForCurrent: "Itinakda ang wika para sa kasalukuyang chat: %1",
			noPermission: "Tanging admin ng bot lamang ang makakagamit ng utos na ito",
			langNotFound: "Hindi mahanap ang wika: %1"
		},
		ceb: {
			setLangForAll: "Gipili ang default nga pinulongan sa bot nga: %1",
			setLangForCurrent: "Gipili ang pinulongan alang sa kasamtangang chat: %1",
			noPermission: "Tanging bot admin ra ang makagamit ani nga mando",
			langNotFound: "Wala nahanap ang pinulongan: %1"
		}
	},
